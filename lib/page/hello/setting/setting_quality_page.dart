            ...
            child: ListView(
              children: [
                ...
                if (Platform.isWindows || Platform.isMacOS)
                  ListTile(
                    ...
                    subtitle: Text(
                      ...
                      style: TextStyle(
                        color: Platform.isWindows ? Colors.blue : Colors.grey,
                      ),
                    ),
                    onTap: () {
                      showDialog(
                ...
                ListTile(
                  ...
                  trailing: SettingSelectMenu(
                    index:
                        userSetting.crossAdapt ? 3 : userSetting.crossCount - 2,
                    items: ['2', '3', '4', "Adapt"],
                ...
                if (!userSetting.useWaterfallFlow)
                  ListTile(
                    ...
                    trailing: Text(
                      userSetting.gridAspectRatio.toStringAsFixed(2),
                    ),
                  ),
                Divider(),
                SwitchListTile(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  Languages.map((e) => e.language).toList()[userSetting
                      .languageNum],
                ),
