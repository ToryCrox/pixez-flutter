      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.sd_storage_rounded, '文件大小', _store.dbSize.formatFileSize()),
            const SizedBox(height: 8),
            _buildInfoRow(Icons.table_rows_rounded, '表数量', _store.tables.length.toString()),
          ],
        ),
      ),
    );
              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => TableDataViewerPage(
                        store: _store,
